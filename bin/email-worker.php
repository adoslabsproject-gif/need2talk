...
/**
 * ENTERPRISE EMAIL WORKER - Linux Independent Version
 *
...
class EnterpriseEmailWorker
{
    ...
    {
        $this->workerId = $config['worker_id'] ?? 'linux_worker_'.uniqid().'_'.getmypid();
...
if ($showHelp) {
    echo "🚀 ENTERPRISE EMAIL WORKER - Linux Independent\n";
    echo "==========================================\n";
    echo "\n";
    echo "Usage: ./bin/email-worker.php [OPTIONS]\n";
    echo "\n";
    echo "Options:\n";
    ...
    echo "\n";
    echo "Examples:\n";
    echo "  ./bin/email-worker.php\n";
    echo "  ./bin/email-worker.php --batch-size=150 --sleep-seconds=2\n";
    echo "  ./bin/email-worker.php --worker-id=worker_1 --max-runtime=7200\n";
    echo "\n";
    echo "Monitoring:\n";
...
echo "Platform: Linux Independent\n";
echo "==========================================\n\n";
